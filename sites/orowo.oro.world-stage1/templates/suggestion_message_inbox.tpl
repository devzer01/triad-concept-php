...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr bgcolor="{cycle values="#006de0,#003873"}" class="b_font">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<input id="delete_button_x" name="delete_button_x" type="submit" value="{#Delete#}" onClick="return confirm('Are you sure to delete selected message?')" class="button"></td>
	</tr>	
</table>
</form>
{else}
