<?php
	class ger
	{
    	...
    	static $wemissu = "Wir vermissen dich auf <a href='http://www.Flirt48.net'>Flirt48.net!</a> Unten findest du die Profile von 4 Mitgliedern, die deinen Vorstellungen hoffentlich ensprechen.";
		...
		static $email_testmember_subject = 'Flirt48.net: Dein Benutzername und Passwort';

		static $email_delete_picture_subject = "Bild abgelehnt";

		static $email_missing ='Wir vermissen dich auf Flirt48.net!';

		static $email_reminder_subject = 'Es liegt eine neue Nachricht für dich bereit bei Flirt48.net';

		static $validation = 'Validation Code';

		static $register_membership_complete = 'Herzlich Willkommen! Du hast dich erfolgreich auf www.Flirt48.net registriert und wirst gleich zu deinem Nutzerprofil weiter geleitet!';
		...
		static $register_testmembership_complete3 = 'Vielen Dank für deine Registrierung bei Flirt48.net. Eine Email ist bereits an die<br/>von dir angegebene Email-
		adresse unterwegs.';
		...
		static $err_blank_valid_code = 'Dieser code ist leider ungültig!';
...
$sender';
		...
		static $ecard_subject = 'Eine Flirt48.net E-Card für dich!';
		...
		static $ecard_send_subject = 'Deine Flirt48.net E-Card wurde erfolgreich versandt';

		static $ecard_send_message = 'Deine Flirt48.net E-Card wurde erfolgreich versandt!';

		static $edit_alert = 'Das Profil befindet sich bereits in Bearbeitung!';

		static $view_ecard = 'E-Card ansehen';

		static $first_time_inbox_subject = "Willkommen bei Flirt48.net";
		static $first_time_inbox_message = "Hallo und herzlich Willkommen bei Flirt48.net, dem Flirtportal zum Kennenlernen, Flirten und Verlieben.
  ...
  Liebe Grüße von deiner Gabi, der \"Kummerkastentante\"";
		...
		static $mobile_verify_message = "Willkommen bei Flirt48.net, bitte gebe diesen Verifizierungscode ein: ";
		...
		static $not_enough_coin = "Du hast nicht mehr genug COINS um SMS zu versenden, bitte buche dein COIN-Konto auf unter: http://www.Flirt48.net.";
		...
		static $email_payment_reminder_subject = "Haben Sie Probleme bei dem Erwerb von einem Coins Paket?";
	}
?>