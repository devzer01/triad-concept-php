...
<!-- {$smarty.template} {$smarty.get.action} -->
...
<div id="grid-container" class="clearfix" >
	...
	{elseif $smarty.get.action eq "admin_managecoin"}
		{include file="admin_managecoin.tpl"}
	{elseif $smarty.get.action eq "admin_emoticons"}
		{include file="admin_emoticons.tpl"}
	{elseif $smarty.get.action eq "admin_gifts"}
		{include file="admin_gifts.tpl"}
	{elseif $smarty.get.action eq "admin_gift_categories"}
		{include file="admin_gift_categories.tpl"}
