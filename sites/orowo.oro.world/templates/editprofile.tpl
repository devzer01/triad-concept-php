...
<div class="container-edit-profile-group">			
	...
	<span>
		...
		{html_options options=$month id="month" name="month" selected=$save.month style="width:110px; margin-left:5px;" class="formfield_01"} 
...
<div class="container-edit-profile-group">
	...
	<span>
		<textarea id="description" name="description" columns="20" rows="12" style="width:450px" onkeyup="checkNullTextArea(this, 'Bitte teilen Sie uns abit mehr über sich.')" onblur="checkNullTextArea(this, 'Bitte teilen Sie uns abit mehr über sich.')" class="description-edit">{$save.description|stripslashes}</textarea>	
	</span>
	<br class="clear"/>
	<label></label>
	<br class="clear" />
...
<a href="#" onclick="if(validateEditProfile()) jQuery('#editProfile').submit(); return false;" class="btn-yellow-left">{#SUBMIT#}</a>
<br class="clear" />
</form>
