<div class="container-metropopup">
	...
	<input id="f_email" name="f_email" type="text" style="width:350px; margin-top:3px;" placeholder="{#Your#} {#Email#}" class="formfield_01 field-forget" onkeypress="return isValidCharacterPattern(event,this.value,2)" />
