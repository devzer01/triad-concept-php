...
(function($){
	...
	*/
	var Gritter = {
		...
		_tpl_wrap: '<div id="gritter-container"><div id="gritter-container-in"><div id="gritter-notice-wrapper"></div></div></div>',
		...
		*/
		add: function(params){
			...
			// Noi modified on 2012-05-14
			// Clicking on image go to the link
			$(item).find('.gritter-image').click(function(){
				Gritter.removeSpecific(number, {}, null, true);
